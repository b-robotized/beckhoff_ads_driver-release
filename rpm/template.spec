...
Name:           ros-rolling-beckhoff-ads-hardware-interface
Version:        1.0.0
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS beckhoff_ads_hardware_interface package

License:        Apache-2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-ads-vendor
...
BuildRequires:  ros-rolling-ads-vendor
...
%changelog
* Thu Oct 16 2025 Nikola Banovic <nikola.banovic@b-robotized.com> - 1.0.0-2
- Autogenerated by Bloom

* Thu Oct 16 2025 Nikola Banovic <nikola.banovic@b-robotized.com> - 1.0.0-1
- Autogenerated by Bloom
